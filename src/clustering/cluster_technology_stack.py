...
def main():
    ...
    parser.add_argument(
        ...
        help="Path to project_technologies_filtered.csv "
             ...
             "If not provided, defaults to data/{input}/technological/technologies_filtered.csv",
    )
    parser.add_argument(
        "--filter-projects",
        default=None,
    ...
    # Set default csv_path based on input if not provided
    if args.csv_path is None:
        args.csv_path = f"../../data/{args.input}/technological/technologies_filtered.csv"

    # Create output directory if it doesn't exist
    output_dir = f"../../data/{args.input}/clustering"
    ...
    for current_method in methods_to_run:
        ...
        tech_mat_out = f"{output_dir}/ecosystems_tech_matrix_{current_method}.csv"
        ...
        if current_method == "hdbscan":
            ...
            if args.sweep_resolution:
                ...
                # Save sweep results
                sweep_out = f"{output_dir}/ecosystems_resolution_sweep_{current_method}.csv"
            ...
            stability_out = f"{output_dir}/ecosystems_stability_{current_method}.csv"
        ...
        proj_out = f"{output_dir}/ecosystems_project_assignments_{current_method}.csv"
        ...
        summary_out = f"{output_dir}/ecosystems_cluster_summary_{current_method}.csv"
        ...
        # 1. PCA embedding
        embedding_out = f"{output_dir}/ecosystems_embedding_{current_method}.png"
        plot_embedding(
            X,
            best_labels,
            embedding_out,
        ...
        mds_out = f"{output_dir}/ecosystems_mds_{current_method}.png"
        plot_mds_embedding(
            dist_matrix,
            best_labels,
            mds_out,
        ...
        tsne_out = f"{output_dir}/ecosystems_tsne_{current_method}.png"
        plot_tsne_embedding(
            X,
            best_labels,
            tsne_out,
        ...
        heatmap_out = f"{output_dir}/ecosystems_heatmap_{current_method}.png"
        plot_heatmap(
            X,
            best_labels,
            tech_names,
        ...
        size_out = f"{output_dir}/ecosystems_sizes_{current_method}.png"
