...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='Output CSV file for batch results (default: <input_parent>/social/participation_rate_results.csv)'
    )
    parser.add_argument(
        '--plot-dir',
        type=str,
    ...
    if args.output is None:
        args.output = str(_social_dir / 'participation_rate_results.csv')
