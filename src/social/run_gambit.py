...
def main():
    ...
    parser.add_argument("--input", required=True, help="Name of input directory")
    ...
    if os.path.exists(f"../data/{args.input}/contributors"):
        base_dir = "../data"
    elif os.path.exists(f"../../data/{args.input}/contributors"):
        base_dir = "../../data"
    else:
        print("Error: Could not find data/projects_contributors directory", file=sys.stderr)
        sys.exit(1)

    input_dir = f"{base_dir}/{args.input}/contributors"
    gambit_dir = f"{base_dir}/{args.input}/contributors_gambit"
    merged_dir = f"{base_dir}/{args.input}/contributors_merged"
