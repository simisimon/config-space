...
def main():
    ...
    parser.add_argument(
        ...
        help='Name of the input directory (e.g., "netflix") under ../../data/, '
             'or a direct path to a directory containing *_contributors_merged.csv files'
    )
    parser.add_argument(
        '--output',
        type=str,
    ...
    output_path = Path(args.output) if args.output else _social_dir / 'cross_project_contributors.csv'
