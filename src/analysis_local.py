...
def process_project(project_url: str, project_name: str):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        try:
            ...
            #TODO: Copy result file to remote server
...
if __name__ == "__main__":
    data_file = "../slurm/projects_final_missed.json"

    with open(data_file, 'r') as f:
        projects = json.load(f)
        projects = projects.reverse()  # Reverse the list to start with the last project

    for project in projects:
        print(f"Starting analysis for project: {project['name']}")
        ...
        print(f"Completed analysis for project: {project['name']}.")
